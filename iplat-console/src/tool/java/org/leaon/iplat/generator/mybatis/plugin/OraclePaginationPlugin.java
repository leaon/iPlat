...
package org.leaon.iplat.generator.mybatis.plugin;
...
/**
 * 基于Mybatis Generator的Oracle分页插件。
 *
 * @author Leaon
 * @version 1.0
 * @since 1.0
 ...
 * -------------------------------------------------------------------------------------------------
 * 2012-9-5				Leaon				创建OraclePaginationPlugin.java。
 *
 */
public class OraclePaginationPlugin extends PluginAdapter {
    ...
    public boolean sqlMapSelectByExampleWithoutBLOBsElementGenerated(   
        ...
        pageStart.addAttribute(new Attribute("refid", "page_prefix"));   
    ...
    private void addPage(TopLevelClass topLevelClass,   
        ...
        topLevelClass.addImportedType(new FullyQualifiedJavaType(   
                "org.leaon.iplat.core.commons.pagination.Page"));   
        CommentGenerator commentGenerator = context.getCommentGenerator();   
        Field field = new Field();   
        field.setVisibility(JavaVisibility.PROTECTED);   
        field.setType(new FullyQualifiedJavaType("org.leaon.iplat.core.commons.pagination.Page"));   
        field.setName(name);   
        ...
        method.addParameter(new Parameter(new FullyQualifiedJavaType(   
                "org.leaon.iplat.core.commons.pagination.Page"), name));   
