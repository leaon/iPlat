...
//TODO: add a way to parse for widgets in the injected markup?
	...
	lang.extend(NodeList, {
		...
		innerHTML: function(/*String?||DOMNode?|NodeList?*/value){
			...
			//	example:
			//		assume a DOM created by this markup:
			//	|	<div id="foo">Hello Mars</div>
			//	|	<div id="bar">Hello World</div>
			//		This code returns "Hello Mars":
		...
		text: function(/*String*/value){
			...
			//	example:
			//		assume a DOM created by this markup:
			//	|	<div id="foo">Hello Mars <span>today</span></div>
			//	|	<div id="bar">Hello World</div>
		...
		append: function(/*String||DOMNode||NodeList*/content){
			...
			//	|	<div id="foo">Hello Mars<span>append</span></div>
			//	|	<div id="bar">Hello World<span>append</span></div>
		...
		appendTo: function(/*String*/query){
			...
			//		Results in this DOM structure:
			//	|	Hello Mars<span>append</span>
			//	|	Hello World<span>append</span>
		...
		prepend: function(/*String||DOMNode||NodeList*/content){
			...
			//		Results in this DOM structure:
			//	|	<div id="foo"><span>prepend</span>Hello Mars</div>
			//	|	<div id="bar"><span>prepend</span>Hello World</div>
		...
		prependTo: function(/*String*/query){
			...
			//		Results in this DOM structure:
			//	|	<span>prepend</span>Hello Mars
			//	|	<span>prepend</span>Hello World
		...
		after: function(/*String||Element||NodeList*/content){
			...
			//		Results in this DOM structure:
			//	|	<div id="foo">Hello Mars</div><span>after</span>
			//	|	<div id="bar">Hello World</div><span>after</span>
		...
		insertAfter: function(/*String*/query){
			...
			//		Results in this DOM structure:
			//	|	Hello Mars<span>after</span>
			//	|	Hello World<span>after</span>
		...
		before: function(/*String||DOMNode||NodeList*/content){
			...
			//		Results in this DOM structure:
			//	|	<span>before</span><div id="foo">Hello Mars</div>
			//	|	<span>before</span><div id="bar">Hello World</div>
		...
		insertBefore: function(/*String*/query){
			...
			//		Results in this DOM structure:
			//	|	<span>before</span>Hello Mars
			//	|	<span>before</span>Hello World
